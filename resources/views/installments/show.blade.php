                ...
                <div class="panel-body">
                    <div class="installment-top">
                        ...
                        <div class="installment-next text-right">
                            ...
                            @if(is_null($nextItem))
                                <div class="installment-clear text-center">此訂單已結清</div>
                            @else
                                <div>
                                    <span>近期待還：</span>
                                ...
                                <div class="payment-buttons">
                                    <a class="btn btn-primary btn-sm" href="{{ route('installments.alipay', ['installment' => $installment->id]) }}">支付寶支付</a>
                                    <a class="btn btn-warning btn-sm" href="{{ route('installments.paypal', ['installment' => $installment->id]) }}">Paypal支付</a>
                            ...
                            <tr>
                                ...
                                @if(is_null($item->paid_at))
                                    <!-- 这里使用了我们之前在模型里定义的访问器 -->
                                        ...
                                        @else
                                            <span class="needs-repay">待還款</span>
                                        @endif
                                    @else
                                        <span class="repaid">已還款</span>
                                    @endif
                                </td>
                                <td>￥{{ $item->base }}</td>
                                <td>￥{{ $item->fee }}</td>
                                <td>{{ is_null($item->fine) ? '無' : ('￥'.$item->fine) }}</td>
